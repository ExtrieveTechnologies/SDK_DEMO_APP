...
import com.extrieve.demo.R.color;
        ...
        if (type == 1) {
            ...
            if (docCollectionLen > 0) {
                for (int i = 0; i < docCollectionLen; i++) {
                    ...
                    textView1.setTextColor(Color.parseColor("#06526f"));
                    ...
                    iconDrawable.setColorFilter(new PorterDuffColorFilter(Color.parseColor("#50802D"), PorterDuff.Mode.SRC_IN));
                    ...
                    expandImageView.setBackgroundColor(Color.parseColor("#50802D"));
                    ...
                    collapseImageView.setBackgroundColor(Color.parseColor("#50802D"));
                    ...
                    headerText.setTextColor(Color.parseColor("#06526f"));
                    ...
                    faceCountText.setTextColor(Color.parseColor("#06526f"));
    ...
    private void updateUI() {
        for (int i = 0; i < imageViews.size(); i++) {
            ...
            if (i == firstSelectedIndex) {
                addBorderToImageView(imageView, android.R.color.holo_blue_dark);
            }
            if (i == secondSelectedIndex) {
                addBorderToImageView(imageView, android.R.color.holo_green_dark);
            }
        }
    }
